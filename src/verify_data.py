...
def verify_data_in_milvus():
    ...
    try:
        ...
        print(f"Total de entidades na coleção: {collection.num_entities}")

        # Realiza uma consulta para buscar as 3 primeiras entidades
        # O campo "embedding" é excluído para facilitar a leitura
