...
MILVUS_PORT = "19530"
COLLECTION_NAME = "diario_uniao_roberta" # Nova coleção para este modelo
CSV_FILE_PATH = "C:/projetos-ia/milvus/data/diario_uniao.csv"

# --- Modelo de Embedding ---
# Modelo: all-roberta-large-v1. Um modelo grande baseado na arquitetura RoBERTa.
...
def create_collection_if_not_exists():
    ...
    schema = CollectionSchema(fields, description="Coleção para o modelo all-roberta-large-v1")
