...
MILVUS_PORT = "19530"
COLLECTION_NAME = "diario_uniao_bert_pt" # Nova coleção para este modelo
CSV_FILE_PATH = "C:/projetos-ia/milvus/data/diario_uniao.csv"

# --- Modelo de Embedding ---
# Modelo: neuralmind/bert-base-portuguese-cased. Um BERT treinado especificamente para o português.
...
def create_collection_if_not_exists():
    ...
    schema = CollectionSchema(fields, description="Coleção para o modelo bert-base-portuguese-cased")
