...
MILVUS_PORT = "19530"
COLLECTION_NAME = "diario_uniao_l12" # Nova coleção para este modelo
CSV_FILE_PATH = "C:/projetos-ia/milvus/data/diario_uniao.csv"

# --- Modelo de Embedding ---
# Modelo: all-MiniLM-L12-v2. Uma versão maior e potencialmente mais precisa que o L6.
...
def create_collection_if_not_exists():
    ...
    schema = CollectionSchema(fields, description="Coleção para o modelo all-MiniLM-L12-v2")
