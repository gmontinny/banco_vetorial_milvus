...
MILVUS_PORT = "19530"
COLLECTION_NAME = "diario_uniao_xlm_roberta" # Nova coleção para este modelo
CSV_FILE_PATH = "C:/projetos-ia/milvus/data/diario_uniao.csv"

# --- Modelo de Embedding ---
# Modelo: xlm-roberta-base. Um modelo multilíngue treinado em 100 idiomas.
...
def create_collection_if_not_exists():
    ...
    schema = CollectionSchema(fields, description="Coleção para o modelo xlm-roberta-base")
