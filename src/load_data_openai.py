...
MILVUS_PORT = "19530"
COLLECTION_NAME = "diario_uniao_openai" # Nova coleção para este modelo
CSV_FILE_PATH = "C:/projetos-ia/milvus/data/diario_uniao.csv"

# --- Modelo de Embedding ---
# Modelo: text-embedding-ada-002 da OpenAI. É um serviço pago.
MODEL_NAME = 'text-embedding-ada-002'
VECTOR_DIMENSION = 1536 # Dimensão para o modelo text-embedding-ada-002

# --- Configuração da API OpenAI ---
# A chave da API é lida da variável de ambiente para segurança.
...
def get_openai_embedding(text):
    """Gera o embedding para um texto usando a API da OpenAI."""
...
def create_collection_if_not_exists():
    ...
    schema = CollectionSchema(fields, description=f"Coleção para o modelo {MODEL_NAME}")
...
def load_csv_and_prepare_data():
    ...
    print(f"Gerando embeddings com o modelo {MODEL_NAME}... (Isso pode incorrer em custos)")
    # A API da OpenAI processa um texto de cada vez neste exemplo simples
    embeddings = [get_openai_embedding(text) for text in resumos]
