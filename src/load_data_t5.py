...
MILVUS_PORT = "19530"
COLLECTION_NAME = "diario_uniao_t5" # Nova coleção para este modelo
CSV_FILE_PATH = "C:/projetos-ia/milvus/data/diario_uniao.csv"

# --- Modelo de Embedding ---
# Modelo: gtr-t5-large. Modelo grande baseado na arquitetura T5 do Google.
...
def create_collection_if_not_exists():
    ...
    schema = CollectionSchema(fields, description="Coleção para o modelo gtr-t5-large")
